...
//        TableLoader.Fill(); //Not needed
        ...
        //From https://github.com/JeffersonLab/clas12-offline-software/blob/master/reconstruction/dc/src/main/java/org/jlab/rec/dc/timetodistance/TableLoader.java
	 ...
	 */ 
        ...
        double calcTime = tableLoader.calc_Time(doca, dMax, tMax, alphaDeg, bField, iSec, iSL);
        ...
        //DCTimeFunction(int superlayer, double thetaDeg, double docaNorm, double bfield, double[] par);
        ...
        for (int i = 0; i < 100; i++) {
            docaNorm = 0.01*i;
            doca = docaNorm * dMax;
            calcTime = tableLoader.calc_Time(doca, dMax, tMax, alphaDeg, bField, iSec, iSL);
